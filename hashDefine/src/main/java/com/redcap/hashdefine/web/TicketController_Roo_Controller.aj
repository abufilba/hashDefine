...
import com.redcap.hashdefine.web.TicketController;
...
privileged aspect TicketController_Roo_Controller {
    ...
    public String TicketController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            int sizeNo = size == null ? 10 : size.intValue();
            final int firstResult = page == null ? 0 : (page.intValue() - 1) * sizeNo;
            uiModel.addAttribute("tickets", Ticket.findTicketEntries(firstResult, sizeNo));
